...
function SaveForLaterList() {
  ...
  const removeFromSaveForLater = useCartStore(
    (state) => state.removeFromSaveForLater,
  );
  ...
  return (
    <section className="mt-8">
      <h2 className="text-lg font-semibold text-qc-text mb-4">
        Saved for later ({savedItems.items.length} item
        {savedItems.items.length > 1 ? "s" : ""})
      </h2>
            ...
            savedItems.items.map((item) => (
              ...
              >
                <div className="p-3">
                  ...
                  <h3 className="text-sm font-semibold text-qc-text mb-1">
                    {item.product.name}
                  </h3>
                  <p className="text-xs text-qc-muted mb-3 line-clamp-2">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-lg font-bold text-qc-accent">
